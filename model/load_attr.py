...
def attr_aggregate(text_features, dataset_name='pascal_voc', num_classes=20, num_atrr_clusters=112, json_file='./gpt4.0_cluster_a_photo_of4.json',topK=0.9,device='cuda'):
    ...
    attr_features, attr_flag = attr_features.to(device), attr_flag.to(device)
